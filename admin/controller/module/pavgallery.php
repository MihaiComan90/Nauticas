...
class ControllerModulepavgallery extends Controller {
	...
	public function index() {
		...
		$this->load->language('module/pavgallery');
		...
		if( isset($this->request->get['module_id']) && isset($this->request->get['delete']) ){
			...
			$this->response->redirect($this->url->link('module/pavgallery', 'token=' . $this->session->data['token'], 'SSL'));
		}
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			if( isset($this->request->get['module_id']) ) {
				$this->response->redirect($this->url->link('module/pavgallery', 'module_id='.$this->request->get['module_id'].'&token=' . $this->session->data['token'], 'SSL'));
			}else{
		...
		if (isset($this->request->get['module_id']) && ($this->request->server['REQUEST_METHOD'] != 'POST')) {
			...
			$this->data['action'] = $this->url->link('module/pavgallery', 'module_id='.$this->request->get['module_id'].'&token=' . $this->session->data['token'], 'SSL');
		}else {
			$module_info = $default;
		...
		$moduletabs = $this->model_extension_module->getModulesByCode( 'pavgallery' );
	 	$this->data['link'] = $this->url->link('module/pavgallery', 'token=' . $this->session->data['token'] . '', 'SSL');
		...
		$this->response->setOutput($this->load->view('module/pavgallery.tpl', $this->data));
	}
