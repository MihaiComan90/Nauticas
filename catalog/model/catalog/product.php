...
class ModelCatalogProduct extends Model {
	...
	public function getProduct($product_id) {
		...
		//$info = getDocumentProduct($product_id);
        //Selectare nume document si url document
	...
	public function getDocumentProduct($product_id) {

	    $sql = "SELECT filename, name FROM " . DB_PREFIX . "download d 
	    LEFT JOIN " . DB_PREFIX . "product_to_download pd ON pd.download_id=d.download_id
