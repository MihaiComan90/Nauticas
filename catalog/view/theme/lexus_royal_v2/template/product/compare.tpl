    ...
    <div class="table-responsive">
      <table class="table table-bordered">
        ...
        <tr>
          <td></td>
          <?php foreach ($products as $product) { ?>
          <td><input type="button" value="<?php echo $button_cart; ?>" class="btn button" onclick="cart.addcart('<?php echo $product['product_id']; ?>');" /><br/><br/>
            <a href="<?php echo $product['remove']; ?>" class="btn button"><?php echo $button_remove; ?></a></td>
          <?php } ?>
        </tr>
      </table>
    </div>
      ...
      <div class="buttons">
        <div class="pull-right"><a href="<?php echo $continue; ?>" class="btn button btn-default"><?php echo $button_continue; ?></a></div>
      </div>
      <?php } ?>
