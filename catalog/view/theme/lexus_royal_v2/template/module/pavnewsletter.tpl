<div class="<?php echo $prefix; ?> box newsletter_block" id="newsletter_<?php echo $position.$module;?>">
	...
	<div class="box-content description mb-4"><?php echo html_entity_decode( $description );?></div>
	<div class="content">
		<form id="formNewLestter" method="post" action="<?php echo $action; ?>" class="formNewLestter">				
			<div class="input-group">
				...
				<button type="submit" name="submitNewsletter" class="button_mini"><?php echo $objlang->get("button_subscribe"); ?></button>
