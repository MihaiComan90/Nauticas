...
<div class="container">
		...
		<div class="col-md-4 col-xs-12 inner logo">
		...
		<div class="col-md-4 hidden-xs hidden-sm" style="padding-top:20px;" >

  			<div class="mymenu btn-group pull-right" >
			...
			<div class="login pull-right  hidden-xs hidden-sm hidden-md">
