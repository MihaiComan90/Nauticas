...
<style type="text/css">
	#footer,#powered, #pavo-mass-bottom, #header,.product-related,.producttabs,#sidebar-right,#page .show-mobile > div,.product-info .product-action .wishlist,.product-info .product-action .compare,.product-info .review{
		display: none;
	}
	#sys-notification{
		padding-top:15px;
